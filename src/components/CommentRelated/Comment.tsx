...
import type { CreateResult, ReplyTarget } from "./CommentSection";
import "./CommentSystem.css";

interface CommentProps {
  comment: CommentModel;
  onUpdate: (commentId: number, content: string, url: string) => Promise<void>;
  ...
  onReplyClick: (parentId: number, parentAuthor: string) => void;
...
const Comment = ({
  ...
  const [editImage, setEditImage] = useState<string | null>(comment.url || null);
    ...
    <>
      <div className={`comment-item ${isReply ? "comment-reply" : ""}`}>
        ...
        <div className="comment-avatar" aria-hidden>
          <Avatar src={comment.profileUrl} alt={displayAuthor} size={36} />
        </div>
          ...
          <div className="comment-header">
            <div className="comment-author-info">
              ...
              <span className="comment-date">
                {formatBoardPreviewDate(comment.createdAt)}
              </span>
              {isCommentEdited() && (
